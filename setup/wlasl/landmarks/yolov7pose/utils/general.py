...
from yolov7pose.utils.google_utils import gsutil_getsize
from yolov7pose.utils.metrics import fitness
from yolov7pose.utils.torch_utils import init_torch_seeds
...
def non_max_suppression_kpt(prediction, conf_thres=0.25, iou_thres=0.45, classes=None, agnostic=False, multi_label=False,
    ...
    for xi, x in enumerate(prediction):  # image index, image inference
        ...
        # Compute conf
        x[:, 5:5+nc] *= x[:, 4:5].clone()  # conf = obj_conf * cls_conf
