model = dict(
    ...
    cls_head=dict(
        ...
        dropout_ratio=0.5,
        init_std=0.01),
    train_cfg=dict(blending=dict(type='MixupBlending', num_classes=2000, alpha=.2)),
...
lr_config = dict(
    ...
    warmup_iters=25)
total_epochs =100
work_dir = './work_dirs/1/ircsn_ig65m_pretrained_bnfrozen_r50_32x2x1_58e_kinetics400_rgb'
