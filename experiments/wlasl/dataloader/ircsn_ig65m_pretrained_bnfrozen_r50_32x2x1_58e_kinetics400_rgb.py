model = dict(
    ...
    backbone=dict(
        type='ResNet3dCSN',
        pretrained2d=False,
        # pretrained='work_dirs/csn-autsl/csn_autsl_55e.pth',
...
ann_file_train = 'data/wlasl/data_annotations.txt'
...
data = dict(
    ...
    train=dict(
        ...
        ann_file='data/wlasl/data_annotations.txt',
...
lr_config = dict(
    ...
    warmup_iters=16)
total_epochs = 1
work_dir = 'work_dirs/csn-pretrained-wlasl/'
